...
printf("Enter some data to write to shared memory (enter an empty line to finish):\n");
// Read and concatenate multiple lines into the buffer
    ...
    while (1) {
        ...
        // Check for an empty line to finish
        if (line[0] == '\n') {
            break;
        }
